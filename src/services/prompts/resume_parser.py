...
- work_experience: list of {{ company, role, employment_type: string or null, location, start_date, end_date, currently_working, technologies_used[], bullet_points[], achievements[] }}
- projects: list of {{ project_name, project_type: string or null, description, technologies_used[], bullet_points[], github_url, live_url }}
